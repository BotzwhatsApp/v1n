...
let botname = '*_｢ KuzaBase 0.2 ｣ 冬_*' //NAMA BOT
let lolkey = 'isi'
...
let symbol = '*☛*'
let faketeks = `*_｢ KuzaBase 0.2 ｣ 冬_*` 
...
const Ytabilbotz = fs.readFileSync ('./media/subrek.jpg')
...
const fstatus = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "YT : ABIL BOTZ", 'jpegThumbnail': fs.readFileSync('./media/subrek.jpg')}}}
...
${symbol} ABIL BOTZ
${symbol} Farrz
${symbol} AllMySubscriber`
but = [{ buttonId: `.command`, buttonText: { displayText: '𝐌𝐞𝐧𝐮 𝐁𝐨𝐭' }, type: 1 },{ buttonId: `.donasi`, buttonText: { displayText: '𝐃𝐨𝐧𝐚𝐬𝐢' }, type: 1 },{ buttonId: `.sewabot`, buttonText: { displayText: '𝐑𝐞𝐧𝐭 𝐀 𝐁𝐨𝐭' }, type: 1 }]
sendButLocation(from, `*${ucapanWaktu} ${pushname}*`, ok, thumb, but)
break
...
run = process.uptime();
 ...
 description: `_AllMenu_
 KuzaBaseAllMenu
 Note : Subscribe ABIL BOTZ
